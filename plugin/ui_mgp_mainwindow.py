...
class Ui_MGPDialog(object):
    def setupUi(self, MGPDialog):
        ...
        self.groupBoxCentroid.setGeometry(QtCore.QRect(10, 10, 461, 321))
        ...
        self.verticalLayoutWidget_3.setGeometry(QtCore.QRect(0, 20, 461, 301))
        ...
        self.verticalLayout_7.addWidget(self.loadCentroidsButton)
        self.generateCentroidBuffersButton = QtWidgets.QPushButton(self.verticalLayoutWidget_3)
        ...
        self.verticalLayout_7.addWidget(self.generateCentroidBuffersButton)
        ...
        self.groupBoxDisplacer.setGeometry(QtCore.QRect(10, 10, 461, 281))
        ...
        self.verticalLayoutWidget_4.setGeometry(QtCore.QRect(0, 20, 461, 261))
        ...
        self.centroidsLayerAdminFieldLabel = QtWidgets.QLabel(self.verticalLayoutWidget_4)
        self.centroidsLayerAdminFieldLabel.setObjectName("centroidsLayerAdminFieldLabel")
        self.formLayout_5.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.centroidsLayerAdminFieldLabel)
        ...
        self.centroidsLayerAdminFieldComboBox = QtWidgets.QComboBox(self.verticalLayoutWidget_4)
        self.centroidsLayerAdminFieldComboBox.setEditable(False)
        self.centroidsLayerAdminFieldComboBox.setObjectName("centroidsLayerAdminFieldComboBox")
        self.formLayout_5.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.centroidsLayerAdminFieldComboBox)
        ...
        self.horizontalLayoutUrbanism = QtWidgets.QHBoxLayout()
        self.horizontalLayoutUrbanism.setObjectName("horizontalLayoutUrbanism")
        self.urbanismCheckBox = QtWidgets.QCheckBox(self.verticalLayoutWidget_4)
        self.urbanismCheckBox.setObjectName("urbanismCheckBox")
        self.horizontalLayoutUrbanism.addWidget(self.urbanismCheckBox)
        self.urbanismFileLineEdit = QtWidgets.QLineEdit(self.verticalLayoutWidget_4)
        self.urbanismFileLineEdit.setEnabled(False)
        self.urbanismFileLineEdit.setObjectName("urbanismFileLineEdit")
        self.horizontalLayoutUrbanism.addWidget(self.urbanismFileLineEdit)
        self.urbanismFileToolButton = QtWidgets.QToolButton(self.verticalLayoutWidget_4)
        self.urbanismFileToolButton.setEnabled(False)
        self.urbanismFileToolButton.setObjectName("urbanismFileToolButton")
        self.horizontalLayoutUrbanism.addWidget(self.urbanismFileToolButton)
        self.urbanismInfoToolButton = QtWidgets.QToolButton(self.verticalLayoutWidget_4)
        self.urbanismInfoToolButton.setText("")
        self.urbanismInfoToolButton.setObjectName("urbanismInfoToolButton")
        self.horizontalLayoutUrbanism.addWidget(self.urbanismInfoToolButton)
        self.verticalLayout_4.addLayout(self.horizontalLayoutUrbanism)
        ...
        self.toggleShowMoreButton.setGeometry(QtCore.QRect(404, 290, 81, 25))
        ...
        self.moreWidget.setGeometry(QtCore.QRect(10, 280, 461, 81))
        ...
        self.verticalLayoutWidget_5.setGeometry(QtCore.QRect(0, 30, 461, 41))
        ...
        self.horizontalLayout_2.addWidget(self.exportDisplacedCentroidsButton)
        self.displacedCentroidsOpenFileToolButton = QtWidgets.QToolButton(self.verticalLayoutWidget_5)
        self.displacedCentroidsOpenFileToolButton.setMaximumSize(QtCore.QSize(30, 30))
        self.displacedCentroidsOpenFileToolButton.setText("")
        self.displacedCentroidsOpenFileToolButton.setObjectName("displacedCentroidsOpenFileToolButton")
        self.horizontalLayout_2.addWidget(self.displacedCentroidsOpenFileToolButton)
        ...
        self.verticalLayoutWidget_6.setGeometry(QtCore.QRect(0, 20, 461, 319))
        ...
        self.covinputsSourceFileToolButton.setMinimumSize(QtCore.QSize(0, 20))
        self.covinputsSourceFileToolButton.setMaximumSize(QtCore.QSize(25, 20))
        ...
        self.covinputsOpenSourceFileToolButton = QtWidgets.QToolButton(self.verticalLayoutWidget_6)
        self.covinputsOpenSourceFileToolButton.setMaximumSize(QtCore.QSize(25, 20))
        self.covinputsOpenSourceFileToolButton.setText("")
        self.covinputsOpenSourceFileToolButton.setObjectName("covinputsOpenSourceFileToolButton")
        self.horizontalLayoutCSF_2.addWidget(self.covinputsOpenSourceFileToolButton)
        ...
        self.horizontalLayout.addWidget(self.computeCovariatesButton)
        self.covoutputsOpenFileToolButton = QtWidgets.QToolButton(self.verticalLayoutWidget_6)
        self.covoutputsOpenFileToolButton.setMaximumSize(QtCore.QSize(30, 30))
        self.covoutputsOpenFileToolButton.setText("")
        self.covoutputsOpenFileToolButton.setObjectName("covoutputsOpenFileToolButton")
        self.horizontalLayout.addWidget(self.covoutputsOpenFileToolButton)
        ...
        self.labelLogo.setGeometry(QtCore.QRect(310, 20, 177, 35))
        ...
        self.labelLogo.setStyleSheet("background-image: url(:/plugins/MGP/logo_wo-unicef.png);")
        ...
        self.l_status = QtWidgets.QLabel(self.widget)
        self.l_status.setGeometry(QtCore.QRect(0, 0, 301, 75))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.l_status.sizePolicy().hasHeightForWidth())
        self.l_status.setSizePolicy(sizePolicy)
        self.l_status.setMinimumSize(QtCore.QSize(90, 75))
        self.l_status.setMaximumSize(QtCore.QSize(16777213, 40))
        self.l_status.setTextFormat(QtCore.Qt.AutoText)
        self.l_status.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        ...
        self.actionrun = QtWidgets.QAction(MGPDialog)
    ...
    def retranslateUi(self, MGPDialog):
        ...
        self.centroidsLayerAdminFieldLabel.setText(_translate("MGPDialog", "Admin Identifier (HH7A)"))
        ...
        self.l_status.setText(_translate("MGPDialog", "Ready"))
